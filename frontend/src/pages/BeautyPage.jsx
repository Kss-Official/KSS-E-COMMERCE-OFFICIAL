...
export default function BeautyPage() {
  ...
  const [productsList, setProductsList] = useState(initialBeautyProducts);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-6">
        ...
        <div className="lg:hidden flex items-center justify-between bg-white p-3.5 rounded-xl shadow-sm border border-gray-200 mb-4">
          ...
          >
            ...
            {(selectedBrands.length > 0 || minRating > 0 || maxPrice < 5000) && (
          ...
          >
            ...
            <div className="space-y-3 pt-3 border-t border-gray-100">
              ...
              <input
                ...
                style={{
                  background: `linear-gradient(to right, #063328 0%, #063328 ${Math.min(100, Math.max(0, ((maxPrice - 200) / (5000 - 200)) * 100))}%, #e2e8f0 ${Math.min(100, Math.max(0, ((maxPrice - 200) / (5000 - 200)) * 100))}%, #e2e8f0 100%)`
                }}
