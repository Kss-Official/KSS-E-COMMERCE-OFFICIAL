    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('CUSTOMER', 'Customer'), ('ADMIN', 'Admin / Staff'), ('WAREHOUSE', 'Warehouse Operator'), ('DELIVERY_AGENT', 'Delivery Agent')], default='CUSTOMER', max_length=20)),
